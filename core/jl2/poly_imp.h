...
static void gll_lag_02(double *p, double *data,
...
static void gll_lag_03(double *p, double *data,
                       unsigned n, int d, double xh)
{
  const double *w = data;
  const double x = xh*2;
...
static void gll_lag_04(double *p, double *data,
                       unsigned n, int d, double xh)
{
  const double *w = data;
  const double x = xh*2;
...
static void gll_lag_05(double *p, double *data,
                       unsigned n, int d, double xh)
{
  const double *w = data;
  const double x = xh*2;
...
static void gll_lag_06(double *p, double *data,
                       unsigned n, int d, double xh)
{
  const double *w = data;
  const double x = xh*2;
...
static void gll_lag_07(double *p, double *data,
                       unsigned n, int d, double xh)
{
  const double *w = data;
  const double x = xh*2;
...
static void gll_lag_08(double *p, double *data,
                       unsigned n, int d, double xh)
{
  const double *w = data;
  const double x = xh*2;
...
static void gll_lag_09(double *p, double *data,
                       unsigned n, int d, double xh)
{
  const double *w = data;
  const double x = xh*2;
...
static void gll_lag_10(double *p, double *data,
                       unsigned n, int d, double xh)
{
  const double *w = data;
  const double x = xh*2;
...
static void gll_lag_11(double *p, double *data,
                       unsigned n, int d, double xh)
{
  const double *w = data;
  const double x = xh*2;
...
static void gll_lag_12(double *p, double *data,
                       unsigned n, int d, double xh)
{
  const double *w = data;
  const double x = xh*2;
...
static void gll_lag_13(double *p, double *data,
                       unsigned n, int d, double xh)
{
  const double *w = data;
  const double x = xh*2;
...
static void gll_lag_14(double *p, double *data,
                       unsigned n, int d, double xh)
{
  const double *w = data;
  const double x = xh*2;
...
static void gll_lag_15(double *p, double *data,
                       unsigned n, int d, double xh)
{
  const double *w = data;
  const double x = xh*2;
...
static void gll_lag_16(double *p, double *data,
                       unsigned n, int d, double xh)
{
  const double *w = data;
  const double x = xh*2;
